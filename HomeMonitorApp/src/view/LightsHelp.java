...
/**
 * Class that shows a help dialog for the light panel.
 * Will read from a text file containing the info and display it. 
 * @author team11
 *
 */
public class LightsHelp extends JFrame {
	...
	public LightsHelp(){
		super("Lights Support Documentation");
	...
	public void display(){
		...
		panel.add(new JLabel("Lights Support"), BorderLayout.NORTH);
	...
	/**
	 * Reads from the help lights file
	 */
	private void openFile(){
		inStream = null;
		try {
			inStream = new FileInputStream("HFile_Lights.txt");
